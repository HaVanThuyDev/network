      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        ...
        {ytId ? (
          <iframe
            ...
            src={`https://www.youtube-nocookie.com/embed/${ytId}?autoplay=1&mute=${isMuted ? 1 : 0}&playlist=${ytId}&loop=1&controls=0&modestbranding=1&rel=0&showinfo=0&enablejsapi=1&playsinline=1`}
